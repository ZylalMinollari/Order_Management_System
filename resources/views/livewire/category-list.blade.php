        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <x-primary-button class="mb-4" wire:click.prevent="openModal">
                        Add Category
                    </x-primary-button>
                    <div class="overflow-hidden overflow-x-auto mb-4 min-w-full align-middle sm:rounded-md">
                        <table class="min-w-full border divide-y divide-gray-200">
                            ...
                            <tbody wire:sortable="updateOrder" class="bg-white devide-y devide-gray-200 devide-solid">
                                    ...
                                    <tr class="bg-white" wire:sortable.item="{{ $category->id }}"
                                        ...
                                        <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                            @if ($editedCategoryId === $category->id)
                                                ...
                                                <x-primary-button wire:click="cancelEditCategory">
                                                    Cancel
                                                </x-primary-button>
                                            @else
            ...
            <form wire:submit.prevent="save" class="w-full">
                <div class="flex flex-col items-start p-4">
                    ...
                    <div class="mb-2 w-full">
                        ...
                        <input wire:model="category.name" id="category.name" wire:keyup='generateSlug'
                    ...
                    <div class="mt-4 ml-auto">
                        ...
                        <button wire:click.prevent="$set('showModal', false)"
                            class="px-4 py-2 font-bold text-white bg-gray-500 rounded hover:bg-gray-700" type="button"
                            data-dismiss="modal">
                            Close
                        </button>
                    </div>
